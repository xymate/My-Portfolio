...
function Navbar() {
    ...
    return (
        <>
            <nav>
                <div className="nav">
                <Link to="Home" offset={-150} ><h2>Xy<span>Mate.</span></h2></Link>
                <ul>
                    ...
                    <li><Link to="Skills" activeClass='active' offset={-100} spy={true}  onClick={navclose}><i className='fas fa-archive' ></i>My Skills</Link></li>
